...
DISCLAIMER: THIS WAS A SCRIPT CREATED BY SOMEONE ELSE BUT CONTAINED OUTDATED CODE. I 
UPDATED IT SO THAT IT WORKS WITH NEWER VERSIONS OF PYTHON. IT WAS OPEN SOURCE ORIGINALLY.
I AM SHARING MY UPDATED VERSION.
 
Usage:
    gff_to_genbank_UPDATED.py <GFF annotation file> [<FASTA sequence file> <molecule type>]
 ...
 Do not use brackets in command line, they simply designate optional arguments
 
 EX:
  gff_to_genbank_UPDATED.py file.gff file.fasta DNA
